...
const TestimonialHead = () => {
  ...
  return (
    ...
    <motion.div ref={ref} initial={{ opacity: 0, scale: 0 }}
     ...
     <h2 className="font-extrabold text-[20px] md:text-[36px] lg:text-[60px]">Hear From Our <span className="text-primary">Happy Clients</span></h2>
     <h3 className="font-bold text-[16px] text-slate-600">Home / Testimonials</h3>
    </motion.div>
    </div>
  );
};
