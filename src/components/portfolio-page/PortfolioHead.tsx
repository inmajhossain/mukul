...
const PortfolioHead = () => {
  ...
  return (
    ...
    <motion.div ref={ref} initial={{ opacity: 0, scale: 0 }}
     ...
     <h2 className="font-extrabold text-[20px] md:text-[36px] lg:text-[60px]">Our Project <span className="text-primary">Masterpieces</span></h2>
     <h3 className="font-bold text-[16px] text-slate-600">Home / Portfolio</h3>
    </motion.div>
    </div>
  );
};
